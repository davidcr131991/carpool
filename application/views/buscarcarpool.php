...
?>
	<div class="row-fluid" id="main-content">
		<div class="span1"></div>
		<div class="span5"> 
			<h2 align="center"><small>Buscar ride preferido</small></h2>
			<hr>
      		<br/>
			<form method="post" action="getride.php">
          <?php if(isset($_POST['action'])){?>
           <input type="hidden" name="action" value="search" />
       		 <input type="text" name="from" value="<?php echo $_POST['from']?>" data-provide="typeahead" class="typeahead" placeholder="Inicio ride" required/><br/>
    	    	<input type="text" name="to" value="<?php echo $_POST['to']?>" data-provide="typeahead" class="typeahead" placeholder="Destino"  required/><br/>

    	    	
Rango de tiempo para esperar su ride: <br/>
    	    	Hora de inicio:
...
Hora de finalización:
              ...
              <span class="add-on">
    	    	...
    	    	<label class="checkbox inline">
   				 ...
   				 <label class="checkbox inline">
    				<input type="checkbox" id="inlineCheckbox3" name="auto" value="Auto"> otro
   				 </label>
   				 <br/>
   				 <br/>
      ...
      <?php } else{ ?>
      <input type="hidden" name="action" value="search" />
           <input type="text" name="from"  data-provide="typeahead" class="typeahead" placeholder="inicio ride" required/><br/>
		...
		<div class="span5">
      <h2 align="center"><small>Buscar Resultados</small></h2> <hr/>
      <?php if(isset($_POST['action'])){
          $from=$_POST['from'];
          $to=$_POST['to'];
          $uptime=$_POST['uptime'];
          ...
          if(mysql_num_rows($result)==0){
                echo("<p align='center'>No hay proximos car pools que coincidan con su solicitud </p>\n");
              }
